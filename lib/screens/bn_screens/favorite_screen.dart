 ...
 // }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<FavoriteGetxController>(
          builder: (controller) {
                                         ...
                                         CircleAvatar(
                                             ...
                                             child:  IconButton(
                                                icon:Icon( Icons.favorite),
                                                  onPressed: () async{
                                                    await changeFavorite(id:controller.product![index].id ,
                                                    product: controller.product![index]);
                                                    changeFavoriteColor(status: controller.product![index].isFavorite);
                                                  } ,
                                                  color:changeFavoriteColor(status: controller.product![index].isFavorite),
                                         ) ),
                                         const SizedBox(width:2),
